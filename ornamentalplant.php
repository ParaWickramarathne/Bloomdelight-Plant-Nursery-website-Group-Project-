...
<html>
  <head>
    ...
    <title>Ornemental Plants</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="ornamentalplant.css">
    <!-- fontawesome icon -->
  ...
  <body>
    ...
    <section class = "menu">
      <div class = "menu-container">
        <div class = "menu-head">
          ...
          <p>Ornamental Plants can decorate your garden they are usually grow in the flower garden for the display of their flowers.</p>
        </div>

        <div class = "menu-btns">
         <button type = "button" class = "menu-btn active-btn" id = "featured">ORNEMENTAL PLANTS /</button>
          <button type = "button" class = "menu-btn" id = "today-special"><a href="home.php">HOME</button>
        </div>
        ...
        <div class = "food-items">
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/agronima.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Agronima</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.750.00</h3>
              <ul class = "rating">
          ...
          <div class = "food-item today-special">
            <div class = "food-img">
              <img src = "images/cypress.jpg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Cypress</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item new-arrival">
            <div class = "food-img">
              <img src = "images/mangrove.jpg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Mangrove</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/pitoniya.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Pitoniya</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item today-special">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Sensaweriya</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.750.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item new-arrival">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Tan-tanas</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item featured">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Kettas Plants</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.150.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item today-special">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Bigoniya 1</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.200.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item new-arrival">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Bigoniya 2</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.200.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item featured">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Bigoniya 3</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item today-special">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Egronima</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.750.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item new-arrival">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Dewadara1</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.200.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item featured">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Dewadara2</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.250.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item new-arrival">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Kettas</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.500.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
                <li><i class = "fas fa-star"></i></li>
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item featured">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Decoration Plant</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.150.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item today-special">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Dewadara3</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.150.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item new-arrival">
            ...
            <div class = "food-content">
              <h2 class = "food-name">Eggronima2</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.150.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
    ...
    <script src="css/category1.js"></script>
  </body>
</html>