...
<html>
  <head>
    ...
    <title>Fruit & Fruit Plants</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="fruitplants.css">
    <!-- fontawesome icon -->
    ...
    <section class = "menu">
      <div class = "menu-container">
        <div class = "menu-head">
          ...
          <p>We provide you the best and quality vegetable plants.</p>
        </div>

        <div class = "menu-btns">
          <button type = "button" class = "menu-btn active-btn" id = "featured">VEGETABLE PLANTS   /</button>
          <button type = "button" class = "menu-btn" id = "today-special"><a href="home.php">HOME</a></button>
        ...
        <div class = "food-items">
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/wambatu.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Brinjals</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item today-special">
            <div class = "food-img">
              <img src = "images/miris.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Chili</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.150.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item new-arrival">
            <div class = "food-img">
              <img src = "images/tomato.jpg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Tomato</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.150.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/mint.webp" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Mint</h2>
              <div class = "line"></div>
