  ...
  <body>
    ...
    <section class = "menu">
      <div class = "menu-container">
        <div class = "menu-head">
          <h2>Fertilizers</h2>
          <p>We provide organic fertilizers and chemical fertilizers.</p>
        </div>

        <div class = "menu-btns">
          <button type = "button" class = "menu-btn active-btn" id = "featured">FERTILIZERS /</button>
        ...
        <div class = "food-items">
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/komposte.webp" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Composte</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item today-special">
            <div class = "food-img">
              <img src = "images/sudukata.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">White Balls</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item new-arrival">
            <div class = "food-img">
              <img src = "images/nilkata.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Blue Balls</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/damkata.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Purple Balls</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.250.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
