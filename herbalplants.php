...
<html>
  <head>
    ...
    <link rel="stylesheet" href="herbalplants.css">
    <!-- fontawesome icon -->
  ...
  <body>
    ...
    <section class = "menu">
      <div class = "menu-container">
        <div class = "menu-head">
          <h2>Herbal Plants</h2>
          <p>We provide our customers the best and healthy herbal Plants.</p>
        </div>

        <div class = "menu-btns">
        
          <button type = "button" class = "menu-btn active-btn" id = "featured">HERBAL PLANTS /</button>
        ...
        <div class = "food-items">
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/Aloe-Vera-Plant.webp" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Aloe Vera</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item today-special">
            <div class = "food-img">
              <img src = "images/suduhadun.webp" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">White Sabdlewood</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item new-arrival">
            <div class = "food-img">
              <img src = "images/kohomba.webp" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Kohomba</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.250.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/karapincha.jpeg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Curry Leaves</h2>
              <div class = "line"></div>
