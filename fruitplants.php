  ...
  <body>
    ...
    <section class = "menu">
      <div class = "menu-container">
        <div class = "menu-head">
          <h2>Fruit Plants</h2>
          <p>Fresh fruits for best price from us.</p>
        </div>

        <div class = "menu-btns">
          <button type = "button" class = "menu-btn active-btn" id = "featured">FRUIT PLANTS /</button>
        ...
        <div class = "food-items">
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/banana.jpg" alt = "food image">
            </div>
          ...
          <div class = "food-item today-special">
            <div class = "food-img">
              <img src = "images/rabutan.jpg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Rabutan</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item new-arrival">
            <div class = "food-img">
              <img src = "images/mango.jpg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Mango</h2>
              <div class = "line"></div>
          ...
          <div class = "food-item featured">
            <div class = "food-img">
              <img src = "images/sathapilla.jpg" alt = "food image">
            </div>
            <div class = "food-content">
              <h2 class = "food-name">Sathapilla</h2>
              <div class = "line"></div>
              <h3 class = "food-price">Rs.200.00</h3>
              <ul class = "rating">
                <li><i class = "fas fa-star"></i></li>
          ...
          <div class = "food-item today-special">
            ...
            <div class = "food-content">
              ...
              <p class = "category"><button><a href="#">See Now</a></button></p>
            </div>
          </div>
          <!-- end of item -->
